...
class Perception(Node):
    ...
    def __init__(self,trained_model = "/home/andres/Documents/autonomous-vehicle-end-to-end-control-project-template/autonomous-vehicle-end-to-end-control-project-template/epoch_39.pt"):
        ...
        save_dict = torch.load(trained_model, map_location=device, weights_only=True)
        self.model =  UNet()
